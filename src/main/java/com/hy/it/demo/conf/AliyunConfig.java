...
public class AliyunConfig {
    ...
    /* 短信发送 */
    public static Map<String, Object> sendSms(String phone) throws ClientException {
        ...
        String m=getMsgCode();
        request.setTemplateParam("{\"code\":\"" + m + "\"}");
        ...
        if(sendSmsResponse.getCode()!= null && sendSmsResponse.getCode().equals("OK")){
            ...
            map.put("code", 200);
            System.out.println("短信发送成功！验证码：" + m);
        }else {
